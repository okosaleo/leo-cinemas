...
export default function Released() {
  ...
  useEffect(() => {
    ...
    newRequest.get(`/now_playing`,{ cancelToken: cancelToken.token}).then((res) => {
      setData(res.data)
      console.clear()
  ...
  return (
    <div className="h-screen w-full p-10 flex flex-col justify-start items-start bg-[#fbfbfb] mb-20">
        <div className=" text-[#0f0f0f] flex items-start justify-start uppercase"><h2 className="text-4xl">Now Playing</h2></div>

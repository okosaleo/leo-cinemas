...
export default function Trending() {
  ...
  useEffect(() => {
    ...
    newRequest.get(`/popular`,{ cancelToken: cancelToken.token}).then((res) => {
      setData(res.data)
      console.clear()
  ...
  return (
    <div className="h-screen w-full p-10 flex flex-col justify-start items-start bg-[#fbfbfb] mb-20">
        <div className=" text-[#0f0f0f] flex items-start justify-start font-medium uppercase"><h2 className="text-4xl">Popular Movies</h2></div>
